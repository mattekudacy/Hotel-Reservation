...
public class ConnectRoomBookingForm extends javax.swing.JFrame{
    Connection con;
        Statement stmt;
        ResultSet rs;
        ...
        //eto yung mga ginamit ko na variable para dun sa table
        String urt, st,na, cid ,cod, rt,rc;
public void DoConnect(){
        try{
            ...
            JOptionPane.showMessageDialog(ConnectRoomBookingForm.this, err.getMessage());
        }
    }
    public void Refresh_RS_STMT(){
        try {
            ...
            Logger.getLogger(ConnectRoomBookingForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}